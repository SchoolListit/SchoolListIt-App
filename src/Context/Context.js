...
useEffect ( () => {
        ...
        promises.push(axios.get('https://schoolistit.com/wp-json/wp/v2/teachers', {params: params}));
        promises.push(axios.get('https://schoolistit.com/wp-json/wp/v2/schools', {params: params}));
        promises.push(axios.get('https://schoolistit.com/wp-json/wp/v2/grades', {params: params}));
        promises.push(axios.get('https://schoolistit.com/wp-json/wp/v2/subjects', {params: params}));
        promises.push(axios.get('https://schoolistit.com/wp-json/schoolistit/v2/lesson-plans'));
        let localProfile;
